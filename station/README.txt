...
- station-S00.uf2 ... station-S190.uf2 - ready-to-flash station firmware
...
4. Run flash.sh with the station number from 0 to 190 (191...254 are
   wristband GPS record codes, 255 is reserved):
...
checkpoint or ghost. Checkpoint and ghost roles use S1...S190. Value 255 is
